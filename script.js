...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const appData = [
        // --- Catégorie 1: Mousseux Cake ---
        {
            ...
            type: 'Hash',
            quality: 'Exctraction',
            image: 'Nejeu1.jpeg', // Image de la catégorie
        ...
        // --- Catégorie 2: V.V.S TANGER ---
        {
            ...
            type: 'Weed',
            quality: 'Fleurs',
            image: 'Cali2.png', // Image de la catégorie
   ...
   // --- MODIFIÉ : renderHomePage ---
    // Gère l'affichage/masquage des filtres ET le nombre de colonnes de la grille
    function renderHomePage() {
        ...
        if (currentView === 'categories') {
            ...
            productListContainer.style.gridTemplateColumns = 'repeat(1, 1fr)'; // <-- NOUVELLE LIGNE

            // On enlève le bouton "retour" s'il existe
            ...
            // --- GESTION DU STYLE DE GRILLE ---
            productListContainer.style.gridTemplateColumns = 'repeat(2, 1fr)'; // <-- NOUVELLE LIGNE

            const category = appData.find(c => c.id === currentCategoryId);
            
            // On ajoute un bouton "retour" en HAUT des filtres
            const existingBackBtn = filterContainer.querySelector('.back-to-categories-btn');
            if (!existingBackBtn && category) { 
        ...
        filteredCategories.forEach(category => {
            ...
            card.innerHTML = `
                ...
                <div class="info">
                    ...
                    <div class="farm">${category.farm}</div>
                </div>
            `;
    ...
    // Affiche la liste des PRODUITS pour une catégorie (inchangé)
   ...
   function renderProductPage(productId) {
    ...
    function populateFilters() {
        ...
        const allNestedProducts = appData.flatMap(category => category.products);
    ...
    document.body.addEventListener('click', function(e) {
        ...
        if (categoryCard) {
            ...
            currentFilters.searchTerm = ''; // On reset que la recherche
            document.getElementById('search-filter').value = '';
            renderHomePage();
            return;
        }

        // 2. Clic sur une carte PRODUIT
        ...
        if (target.closest('.back-to-categories-btn')) {
            ...
            currentFilters.searchTerm = ''; // On reset que la recherche
            document.getElementById('search-filter').value = '';
            // On garde le filtre qualité/farm actif
            renderHomePage();
            return;
        }
